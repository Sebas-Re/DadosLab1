...
void Partida1Jugador();//ejecucion de ronda completa de un jugador.
...
void FinDePartida1Jugador (char NombreJugador[], int UnJugador[], int tam, int PuntajeFinal);//no se si muestra el final de cada ronda o de partida
