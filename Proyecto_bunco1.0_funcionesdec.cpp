...
void Partida1Jugador(){/// REVISION OK FUNCIONA
///----------------------------------------///
...
void Partida1JugadorManual(){///REVISION OK FUNCIONA
    ...
    for(int y=17; y<=19; y++){
        ...
        if (UnJugador[3] >=21){RondaTerminada = true;}
            ...
            FinDePartida1Jugador(JugadorManual, UnJugador,6, PuntajeFinal);}///FIN DE LA FUNCION
...
///Mganador[0] ES DEL RECIENTE. 1 ES DEL ANTERIOR
